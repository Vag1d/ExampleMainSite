...
$('#dtBasicExample, #dt-more-columns, #dt-less-columns').mdbEditor({
    modalEditor: true
});

$('#dtBasicExample-1, #dt-more-row-col, #dt-less-row-col').mdbEditor({
    rowEditor: true
});
...
let dataSet = [
    ...
    ["Fiona Green", "Chief Operating Officer (COO)", "San Francisco", "2947", "2010-03-11", "$850,000", "Examples"],
